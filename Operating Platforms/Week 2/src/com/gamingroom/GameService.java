...
import java.util.Iterator; // added java. util package for iterator to loop through any collection of objects
...
public class GameService {
	...
	private static GameService instance; // added for the singleton instance of the GameService class
	...
	public Game addGame(String name) {
		...
		while (it.hasNext()) { // while loop that iterates through each element of the 'games' collection.
			...
			if (g.getName().equals(name)) { // checks whether the name of the current 'Game' object matches the specified name.
				...
				break; // exits loop after specified 'Game' object has been found
			}
		}
	...
	public Game getGame(long id) {
		...
		while (it.hasNext()) { // while loop is used to iterate through the collection 
			...
			if (g.getId() == id) { // if statement used to compare id of current game object 'g' with given 'id'
				...
				break;			   // then the loop is exited using the break statement
			}
		}
	...
	public Game getGame(String name) {
		...
		while (it.hasNext()) {
			...
			if (g.getName().equals(name)) { // The if statement checks if the name of the current Game object g 
				...
				break;						// the game variable, and exits the loop using the break statement.
			}
		}
	...
	// returns the singleton instance of the GameService Class
