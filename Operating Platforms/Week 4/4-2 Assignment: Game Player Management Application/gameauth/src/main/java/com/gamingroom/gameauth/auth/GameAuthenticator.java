...
public class GameAuthenticator implements Authenticator<BasicCredentials, GameUser> 
{
    ...
    public Optional<GameUser> authenticate(BasicCredentials credentials) throws AuthenticationException 
    {
        if (VALID_USERS.containsKey(credentials.getUsername()) && "password".equals(credentials.getPassword())) 
        {
            ...
            /*
             * checks if the provided credentials match a valid username and password pair, and returns a new GameUser 
             * object if the credentials are valid. reference: https://howtodoinjava.com/dropwizard/dropwizard-basic-auth-security-example/ 
             * - Marc Aradillas
             */
        }
